...
void CPickingPage::Resize(UISize& uiSize)
{
    ...
    m_buttonCreateCircle.MoveWindow    (0,                 btnHeightGap * 7, thirdBtnWidth,      uiSize.buttonHeight * 2);
    m_buttonCreateRectangle.MoveWindow (thirdBtnWidth,     btnHeightGap * 7, thirdBtnWidth,      uiSize.buttonHeight * 2);
    m_buttonCreateTriangle.MoveWindow  (thirdBtnWidth * 2, btnHeightGap * 7, thirdBtnWidth,      uiSize.buttonHeight * 2);
