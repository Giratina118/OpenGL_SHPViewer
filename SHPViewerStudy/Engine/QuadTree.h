...
public:
	...
	void CreateNode(int32_t level, BoundingBox& boundingBox) { m_nodes.emplace_back(level, boundingBox); m_nodes.back().m_objectIds.reserve(16); } // 노드 생성
	...
	void UpdateTransformObject(int32_t pickingNodeId, int32_t pickingDataId);
};