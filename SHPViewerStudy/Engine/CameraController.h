...
public:
    ...
    void Init(const BoundingBox& boundingBox, int32_t screenWidth, int32_t screenHeight); // 카메라 초기화
    void UpdateAspect(int32_t screenWidth, int32_t screenHeight); // 종횡비 설정
	...
	const glm::dmat4 GetViewProjectionMatrix() const { return viewProjectionMatrix; } // 뷰-투영 행렬 반환
};