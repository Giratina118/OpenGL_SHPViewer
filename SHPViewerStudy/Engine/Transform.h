...
public:
    ...
    glm::dquat rotation = glm::dquat(1, 0, 0, 0); // 방향
    glm::dvec3 scale = glm::dvec3(1.0);          // 크기

public:
    glm::dvec3 GetForward() const { return rotation * glm::dvec3(0, 0, -1); }; // 앞
    glm::dvec3 GetRight()   const { return rotation * glm::dvec3(1, 0, 0); };  // 오른쪽
    glm::dvec3 GetUp()      const { return rotation * glm::dvec3(0, 1, 0); };  // 위
