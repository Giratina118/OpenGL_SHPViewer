...
void QuadTree::BuildQuadTree()
{
	...
	PrintElapsedTime(L"Point 쿼드트리 삽입", pointTreeInsertStart);
	...
	PrintElapsedTime(L"Line 쿼드트리 삽입", lineTreeInsertStart);
	...
	PrintElapsedTime(L"Polygon 쿼드트리 삽입", polygonTreeInsertStart);
	...
	PrintElapsedTime(L"쿼드트리 전체", quadTreeBuildStart);
}
